classdef UniformityPatch < Grasppe.Graphics.Patch & Grasppe.PrintUniformity.Graphics.UniformityPlotComponent
  ...
  methods
    function obj = UniformityPatch(parentAxes, dataSource, varargin)
      obj = obj@Grasppe.Graphics.Patch(parentAxes, varargin{:});
  ...
  methods (Access=protected)
    ...
    function createComponent(obj)
      try
        ...
        obj.createComponent@Grasppe.Graphics.Patch();
      end
