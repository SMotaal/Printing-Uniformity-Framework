classdef GrasppeProperty < GrasppePrototype
  ...
  methods
    function obj = GrasppeProperty(component, propertyMeta, value) % Component, Name, DisplayName, Description, Type, EditorContext, Category, Editable, Value)
    ...
    function set.Value(obj, value)
      if obj.RedundantSet || ~isequal(obj.Value, value)
        if obj.Revertable
