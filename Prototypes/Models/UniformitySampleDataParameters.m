classdef UniformitySampleDataParameters < SampleDataParameters
  ...
  methods
    ...
    function model = UniformitySampleDataParameters(caseID, setID, sheetID, variableID)
      model = model@SampleDataParameters();
    ...
    function model = duplicate(model, varargin)
      ...
      model = UniformitySampleDataParameters( ...
