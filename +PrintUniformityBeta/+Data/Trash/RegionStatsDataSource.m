classdef RegionStatsDataSource < PrintUniformityBeta.Data.UniformityDataSource
  ...
  methods (Hidden)
    ...
    function attachPlotObject(obj, plotObject)
      ...
      try
        obj.PlotLabels = PrintUniformityBeta.Graphics.UniformityPlotLabels; ...
          obj.registerHandle(obj.PlotLabels);
        
        obj.PlotLabels.attachPlot(plotObject);
        obj.updatePlotLabels;
        
        if isa(obj.PlotLabels, 'PrintUniformityBeta.Graphics.UniformityPlotLabels') && isvalid(obj.PlotLabels)
    ...
    function [id space] = getDataID(obj, prefix, suffix)
      ...
      [id space] = obj.getDataID@PrintUniformityBeta.Data.UniformityDataSource(prefix, suffix);
    ...
    function [sheetStats] = getSheetStatistics(obj, sheetID, variableID)
      ...
      try
        ...
        %% Get Region Data
        regionData      = GrasppeAlpha.Stats.DataStats.empty;
        aroundData      = GrasppeAlpha.Stats.DataStats.empty;
        acrossData      = GrasppeAlpha.Stats.DataStats.empty;
        ...
        sheetData       = GrasppeAlpha.Stats.DataStats(sheetData, runData.Mean, runData.Sigma);
...
%           end
  ...
  methods
    function updatePlotLabels(obj)
      ...
      try
        if ~isa(obj.PlotLabels, 'PrintUniformityBeta.Graphics.UniformityPlotLabels') ...
...
%         debugStamp(err, 1, obj); end
    ...
    function updateCaseData(obj, source, event)
      ...
      [dataSource regions] = PrintUniformityAlpha.Metrics.generateUPRegions(obj.CaseData);
      obj.Regions = regions;
      
      obj.updateCaseData@PrintUniformityBeta.Data.UniformityDataSource(source, event);
    end
    ...
    function updateSetData(obj, source, event)
      ...
      try
        ...
        obj.updateSetData@PrintUniformityBeta.Data.UniformityDataSource(source, event);
    ...
    function updateSheetData(obj, source, event)
      ...
      obj.updateSheetData@PrintUniformityBeta.Data.UniformityDataSource(source, event);
    ...
    function updateVariableData(obj, source, event)
      ...
      if isequal(obj.VariableID, 'raw')
        ...
        [dataSource stats]    = PrintUniformityAlpha.Stats.generateUPStats(obj.CaseData, obj.SetData.DATA, regions);
        obj.Stats = stats;
      end
      
      obj.updateVariableData@PrintUniformityBeta.Data.UniformityDataSource(source, event);
    ...
    function postprocessSheetData(obj)
      ...
      obj.postprocessSheetData@PrintUniformityBeta.Data.UniformityDataSource;
    ...
    function set.StatsMode(obj, value)
      ...
      obj.StatsMode         = value;
      obj.updateVariableData(obj);
      %GrasppeKit.Utilities.DelayedCall(@(s,e)obj.updateVariableData(obj,e), 1, 'start');
    end
  ...
  methods (Access=protected)
    ...
    function createComponent(obj)
      obj.AllDataEnabled = true;
      obj.createComponent@PrintUniformityBeta.Data.UniformityDataSource;
      %obj.DataReader.preloadSheetData();
      %obj.DataReader.preloadSheetData();
    end
