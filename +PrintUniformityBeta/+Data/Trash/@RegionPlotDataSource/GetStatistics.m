...
function [sheetStats] = getSheetStatistics(obj, sheetID, variableID)
  ...
  try
    ...
    %% Get Sheet Data
    regionData      = getStats(); % GrasppeAlpha.Stats.TransientStats.empty;    
    ...
    aroundData      = getStats(); % GrasppeAlpha.Stats.TransientStats.empty;    
    ...
    %% Get Axial Data
    acrossData      = getStats(); % GrasppeAlpha.Stats.TransientStats.empty;    
