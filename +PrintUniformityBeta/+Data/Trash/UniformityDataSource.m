classdef UniformityDataSource < GrasppeAlpha.Core.Component & GrasppeAlpha.Occam.Process % & GrasppeComponent
  ...
  methods %(Hidden)
    ...
    function data = getAllData(obj)
      ...
      bufferAllData = true; %PrintUniformityBeta.Options.Defaults.BufferSurfData';
      forceBuffer   = true;
  ...
  methods (Access=protected)
    ...
    function initializeDataReader(obj)
      if ~isa(obj.DataReader, 'PrintUniformityBeta.Data.UniformityDataReader') ...
          || ~isvalid(obj.DataReader)
        obj.DataReader = PrintUniformityBeta.Data.UniformityDataReader; ...
