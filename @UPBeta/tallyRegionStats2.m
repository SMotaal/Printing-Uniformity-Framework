...
dataSourceClass     = 'Grasppe.PrintUniformity.Data.RegionPlotDataSource';
statsClass          = 'Grasppe.Stats.TransientStats';
  ...
  for n = 1:setCount
    ...
    for roiSet = roiIDs
      ...
      for r = 1:roiCount
        ...
        roiTally(r).Samples                 = sum(~nanSample);
        roiTally(r).Outliers                = sum(nanSample);
